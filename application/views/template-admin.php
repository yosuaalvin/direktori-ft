        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="<?= site_url(); ?>/getfile/profileImageEdit/true/<?= $identitas->uid?>" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <img src="<?= site_url(); ?>/getfile/profileImageEdit/true/<?= $identitas->uid?>" class="img-circle" alt="User Image">
